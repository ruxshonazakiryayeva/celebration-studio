    ...
    <div className="tpl-emerald min-h-screen bg-[#081814] text-emerald-50 relative overflow-hidden font-sans">
      ...
      <header className="relative z-10 overflow-hidden px-6 pb-16 pt-24 text-center sm:pt-32">
        <div className="mx-auto max-w-xl">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-emerald-400/40 bg-emerald-950/80 text-[10px] font-bold uppercase tracking-[0.3em] text-emerald-300 mb-6 shadow-xl">
          ...
          <h1 className="mt-6 font-serif text-5xl sm:text-7xl leading-[1.05] tracking-tight bg-gradient-to-r from-emerald-200 via-amber-300 to-emerald-100 bg-clip-text text-transparent font-normal drop-shadow-md">
            {invite.name}
          </h1>
